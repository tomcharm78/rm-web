...
import { DeleteChallengeDialog } from '@/components/challenges/delete-challenge-dialog';
...
export default function ChallengeDetailPage() {
  ...
  // Delete is super-only — narrower than isManager, which includes admins.
    ...
    <div className="p-6 lg:p-8 max-w-5xl mx-auto">
          ...
          <div className="text-right shrink-0 flex flex-col items-end gap-3">
            ...
            {isSuper && (
              <button
                ...
                className="inline-flex items-center gap-1.5 rounded-md border border-red-200 bg-red-50 px-2.5 py-1.5 text-xs text-red-700 hover:bg-red-100"
              >
      ...
      {deleteOpen && (
        <DeleteChallengeDialog
          challengeId={c.id}
          challengeTitle={ar ? c.titleAr || c.title : c.title}
